...
const ProfilePage = () => {
    ...
    return ( <
        ...
        <
        button onClick = {
            () => handleEditButtonClick('name') } > { ' ' } { userData.name.isOpened ? 'Close' : 'Edit' } { ' ' } <
        /button>{' '} <
        /StyledRowDiv>{' '} ===
        === = { /* Full name */ } <
        div id = 'name' >
        ...
        /button> <
        /StyledRowDiv> >>>
        >>> > 760671 aa3c76b8db5c80c35991439a4bc70a6d88 <
        ...
        onclick = {
            ...
            />{' '} <
            /StyledColumnDiv>{' '} <
            StyledText className = 'nameVisibility' > { ' ' } { userData.name.value.firstName + ' ' + userData.name.value.lastName } { ' ' } <
            /StyledText>{' '} <
            LineBreak / >
            <
            /div>{' '} { /* Gender */ } { ' ' } <
            ...
            <
            button onClick = {
                () => handleEditButtonClick('gender') } > { ' ' } { userData.gender.isOpened ? 'Close' : 'Edit' } { ' ' } <
            /button>{' '} <
            /StyledRowDiv>{' '} ===
            === =
            "name",
...
placeholder = { < div className = 'select-placeholder-text' > Select gender < /div>} /
    ...
    <
    button onClick = {
        () => handleEditButtonClick('dateOfBirth') } > { ' ' } { userData.dateOfBirth.isOpened ? 'Close' : 'Edit' } { ' ' } <
    /button>{' '} <
    /StyledRowDiv>{' '} <
    ...
    <
    button onClick = {
        () => handleEditButtonClick('email') } > { ' ' } { userData.email.isOpened ? 'Close' : 'Edit' } { ' ' } <
    /button>{' '} <
    /StyledRowDiv>{' '} ===
    === =
    placeholder = { <
    ...
    /> <
    /StyledColumnDiv> <
    StyledText className = 'genderVisibility' > { userData.gender.value } <
    /StyledText> <
    LineBreak / >
    <
    /div> { /* Date of birth */ } <
    ...
    /> <
    /StyledColumnDiv> <
    StyledText className = 'dateOfBirthVisibility' > { userData.dateOfBirth.value } <
    /StyledText> <
    LineBreak / >
    <
    /div> { /* Email address */ } <
    ...
    <
    button onClick = {
        () => handleEditButtonClick('phoneNumber') } > { ' ' } { userData.phoneNumber.isOpened ? 'Close' : 'Edit' } { ' ' } <
    /button>{' '} <
    /StyledRowDiv>{' '} <
    ...
    <
    button onClick = {
        () => handleEditButtonClick('address') } > { ' ' } { userData.address.isOpened ? 'Close' : 'Edit' } { ' ' } <
    /button>{' '} <
    /StyledRowDiv>{' '} <
    ...
    /> <
    /StyledColumnDiv> <
    StyledText className = 'emailVisibility' > { userData.email.value } <
    /StyledText> <
    LineBreak / >
    <
    /div> { /* Phone number */ } <
    ...
    /> <
    /StyledColumnDiv> <
    StyledText className = 'phoneNumberVisibility' > { userData.phoneNumber.value } <
    /StyledText> <
    LineBreak / >
    <
    /div> { /* Address */ } <
    ...
    /> <
    /StyledColumnDiv> <
    StyledText className = 'addressVisibility' > { userData.address.value } <
    /StyledText> >>>
    >>> > 760671 aa3c76b8db5c80c35991439a4bc70a6d88 <
    LineBreak / >
    <
